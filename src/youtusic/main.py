# pyinstaller --noconfirm --log-level=WARN --clean --distpath ".\bin\bin" --workpath ".\bin\build" --name youtusic --onefile --paths ".\youtusic-env\Lib\site-packages" .\src\youtusic\main.py
# pyinstaller --noconfirm --log-level=WARN --clean --distpath "./bin/bin" --workpath "./bin/build" --name youtusic --onefile --paths "./youtusic-env/Lib/site-packages" ./src/youtusic/main.py
# -*- coding: UTF-8 -*-
